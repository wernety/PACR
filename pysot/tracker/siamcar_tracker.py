...
class SiamCARTracker(SiameseTracker):
    ...
    def track(self, img, hp, idx):
        ...
        x_crop_dict = self.get_subwindow(img, self.center_pos,
                                    cfg.TRACK.INSTANCE_SIZE,
                                    round(s_x), self.channel_average, idx=idx, gt_wh=self.gt_size)
        x_crop = x_crop_dict["im_patch_0"]
        ...
        # uc'vte state 中心点和bbox的宽高 中心点是横纵坐标
