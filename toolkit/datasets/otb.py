...
from .video_chx import Video_chx


class OTBVideo(Video, Video_chx):
    """
    Args:
        name: video name
        root: dataset root
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
            gt_rect, attr, load_img=False, is_test = False):
        if is_test:
            print("当前是测试")
            Video_chx.__init__(self, name, root, video_dir,
...
class OTBDataset(Dataset):
    ...
    """
    def __init__(self, name, dataset_root, load_img=False, is_test=False):
